...
describe('BaseType', () => {
  ...
  it('should create one with a name and type', () => {
    const name = 'myType'
      , type = 'custom'
      , result = new BaseType({name: name, type: type})
    ;
  ...
  it('should create one with a name, type and defaultValue', () => {
    const name = 'myType'
      , type = 'custom'
      , defaultValue = 'hello'
      , result = new BaseType({name: name, type: type, defaultValue: defaultValue})
    ;
  ...
  it('should create one with a name, type and optional', () => {
    const name = 'myType'
      , type = 'custom'
      , optional = false
      , result = new BaseType({name: name, type: type, optional: optional})
    ;
  ...
  it('should create one with a name, type, optional and defaultValue', () => {
    const name = 'myType'
      ...
      , defaultValue = 'hello'
      , optional = false
      , result = new BaseType({name: name, type: type, defaultValue: defaultValue, optional: optional})
    ;
  ...
  describe('#getValue()', () => {
    ...
    describe('with type of no default and is optional', () => {
      ...
      const type = new BaseType({name: 'custom', type: 'custom', optional: true});
    ...
    describe('with type with a default and is optional', () => {
      ...
      const type = new BaseType({name: 'custom', type: 'custom', optional: true, defaultValue: DEFAULT_VALUE});
    ...
    describe('with type with no default and is not optional', () => {
      ...
      const type = new BaseType({name: 'custom', type: 'custom', optional: false});
    ...
    describe('with type with no default and is not optional', () => {
      ...
      const type = new BaseType({name: 'custom', type: 'custom', optional: false, defaultValue: DEFAULT_VALUE});
