...
import { getDatePattern, getTimePattern } from './timeUtil';
import HueTime from './HueTime';
import HueDate from './HueDate';
import HueBridgeModelError from '../HueBridgeModelError';

const RANDOMIZED_TIME_REGEX = new RegExp(`^${getDatePattern()}T${getTimePattern()}A${getTimePattern('random')}$`);

type TimeValue = string | RandomizedTime | Date

export default class RandomizedTime implements BridgeTime {
